...
class DialogoResultadosCompletos(QDialog):
    def __init__(self, historial, nombres_clases, parent=None):
        ...
        for metodo in ["Resustitución", "Cross-Validation", "Leave-One-Out"]:
            tab_distancias = self.crear_tabs_distancias(metodo)
            self.tabs_metodos.addTab(tab_distancias, metodo)
    ...
    def crear_tabs_distancias(self, metodo):
        ...
        for distancia in ["Euclidiana", "Mahalanobis", "Probabilidad"]:
            ...
            texto_completo = f"Rendimiento Global ({distancia}): {datos['global']:.2f}%\n\n"
...
class DialogoGraficaFinal(QDialog):
    def __init__(self, historial, nombres_clases, parent=None):
        ...
        estilos = {"Resustitución": "-", "Cross-Validation": "--", "Leave-One-Out": ":"}
        
        x_pos = np.arange(len(nombres_clases))
        
        for dist in ["Euclidiana", "Mahalanobis", "Probabilidad"]:
            for i, met in enumerate(["Resustitución", "Cross-Validation", "Leave-One-Out"]):
        ...
        for dist in ["Euclidiana", "Mahalanobis", "Probabilidad"]:
            datos_dist = []
            for met in ["Resustitución", "Cross-Validation", "Leave-One-Out"]:
                datos_dist.append((met, historial[dist][met]['global']))
...
class Vista(QMainWindow):
    ...
    def configurar_interfaz(self):
        ...
        # SE SACA EL BOTÓN AL PANEL PRINCIPAL PARA EVITAR QUE SE BLOQUEE
    ...
    def habilitar_panel_parametros(self):
        ...
        self.btn_reiniciar.setEnabled(True) # Se habilita en cuanto se sube una imagen
    ...
    def limpiar_interfaz(self):
        ...
        # Eliminamos el selector viejo de memoria para evitar cruces
